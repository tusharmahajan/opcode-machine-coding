...
class OpcodeSimulatorTest {
    ...
    void setup() {
        ...
        registers.add(new Register('E'));
        simulator = new GeneralOpcodeInstruction(registers);
    }
    ...
    @Test
    void testINRDCRContent() {
        List<String> instructions = new ArrayList<>();
        instructions.add("RST");
        instructions.add("SET C 10");
        instructions.add("SET E 14");
        instructions.add("INR E");
        instructions.add("INR E");
        instructions.add("INR E");
        instructions.add("ADD C 12");
        instructions.add("DCR C");
        instructions.add("DCR C");
        instructions.add("DCR C");
        final RegisterState state = simulator.execute(instructions);
        assertEquals(17, state.getRegister('E').getValue());
        assertEquals(19, state.getRegister('C').getValue());
    }
}
